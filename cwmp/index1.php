...
<html lang="en">
    ...
    <body>
        <section id="header">
            ...
            <div>
                ...
                <li><a class="active" href="index1.php">Home</a></li>
                    <li><a href="http://localhost/cwmp/menu">Menu</a></li>    
                    <li><a href="http://localhost/cwmp/about">About</a></li>
                    <li><a href="http://localhost/cwmp/contact">Contact</a></li>
        ...
        <section id="main">
            ...
            <button onclick="window.location.href='menu.php';">Let's Eat</button>
        </section>
